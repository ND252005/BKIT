...
angle_speed_thresholds = [
    ...
    (7, 35),  # (Góc trung bình, tốc độ trung bình)
    (16, 32),  # (Góc lớn hơn, tốc độ giảm)
...
def pid_controller(angle, dt):
    global previous_error, integral, previous_output
